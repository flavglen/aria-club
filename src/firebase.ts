...
import { getFirestore, collection, getDocs, Firestore, addDoc,doc, setDoc, getDoc} from 'firebase/firestore/lite';
...
export  {app, db, collection, getDocs, addDoc,doc, setDoc, getDoc};
